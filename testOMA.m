...
% 
%     factor_amp=(max(Rx.Datacorrelate)-min(Rx.Datacorrelate))/2
%     factor_mean=(max(Rx.Datacorrelate)+min(Rx.Datacorrelate))/2
%     datashift=Rx.Datacorrelate-factor_mean;
%     Rx.normalizedtest=datashift/factor_amp;
%     factor=[factor_amp factor_mean];
% end
% 
% Rx.normalizedtest=datashifttest
% Rx.norfactortest= factortest
% 
...
%% BER Estimate w/o EQ
    ...
    [Rx.Pam4levelmean Rx.Pam4levelstd Rx.Databitgroup]=RxMeanStd(Rx.Databit,PAM_order);      %%use this alan
